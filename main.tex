...
\author[Willem Waegeman]{Willem Waegeman, Eyke H\"ullermeier and Krzysztof Dembczysnki} 
...
%\vspace{0.8cm}
\begin{center}
\includegraphics[width=0.35\textwidth]{Figures/pictures/multiclass0}
\includegraphics[width=0.7\textwidth]{Figures/pictures/multiclass}
\end{center}
\end{frame}
