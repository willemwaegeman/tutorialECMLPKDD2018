...
\begin{frame}{Low-rank approximation of the parameter matrix\footnote{Chen et al., A convex formulation for learning shared structures from
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\frame{
  \frametitle{Low-rank approximation of the parameter matrix}
...
\begin{frame}{Low-rank approximation of the parameter matrix}{Overview of methods}
